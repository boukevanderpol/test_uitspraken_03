...
server <- function(input, output) {
    ...
    output$distPlot <- renderPlot({
        ...
        # -----------------------
        b <- read.delim("D:/DummyDir/verz_gegevens/verz_geg_uitspraken_totaal.txt",
                        header = TRUE,
                        sep = "|",
                        #                na.strings = "NA",
        ...
        # ---------------------------------------------------------------------
        # Histogram heeft een numerieke vector als input. Volgende regel zorgt 
        # dat een kolom (weekdag) van de dataframe wordt geselecteerd en in 
        # een vecotr wordt geplaatst.
        # ---------------------------------------------------------------------
